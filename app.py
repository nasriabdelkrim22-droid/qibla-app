...
st.write("أداة دقيقة للمهندسين والمساحين في منطقة سيدي بلعباس وما جاورها")
...
if st.button("حساب الزاوية الهندسية"):
    ...
    st.markdown("---")
    st.caption("⚠️ ملاحظة: هذا الحساب يعتمد على مسقط UTM Zone 30N ويستخدم لمشاريع بلدية زروالة وسيدي بلعباس.")
